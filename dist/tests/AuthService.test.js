...
describe('AuthService', () => {
    ...
    beforeEach(async () => {
        ...
        authService = new AuthService_1.AuthService(dbService);
    ...
    describe('User Management', () => {
        ...
        it('should not create duplicate users', async () => {
            ...
            await expect(authService.createUser('testuser', 'password123', 'user')).rejects.toThrow('Username already exists');
        });
    });
    ...
    describe('Token Management', () => {
        ...
        it('should verify valid tokens', async () => {
            ...
            expect(decoded === null || decoded === void 0 ? void 0 : decoded.role).toBe('user');
        });
